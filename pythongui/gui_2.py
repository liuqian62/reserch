...
def find_frame():
    ...
    left_raw, right_raw = find_subImg(templateImg[:,index_raw,:256],templateImg[:,index_mirro,256:],tempImg_match,templateImg_match_mirro,templateImg,index_raw,index_mirro)
